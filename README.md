...
**How it works**:
1. GPT-4 analyzes the complex request
2. Breaks it into a sequence of simple tasks
3. Executes each task automatically
...
Router
    ...
    ├─ multi_step → Orchestrator Node (executes multiple tasks)
...
1. **Plan-and-Execute for Multi-Step Tasks** - Complex requests use 3-stage architecture (Planner → Executor → Solver)
